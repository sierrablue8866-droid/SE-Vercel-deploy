/**
 * Houyez-Style Portal — typed data source + static seed
 * ────────────────────────────────────────────────────────────────────────────
 * Migrated from Sierra-Estates-Final's data/houyez-properties.ts.
 *
 * This file is the SINGLE SOURCE OF TRUTH for:
 *   - TypeScript types for the four Houyez collections
 *   - Static seed data (used as fallback when Firestore is empty / not configured)
 *   - Filter option lists for the listings grid
 *
 * The seed data mirrors what's in Firestore after running
 * POST /api/houyez/seed. The useHouyezPortal hook subscribes to Firestore
 * and replaces these arrays with live data the moment it connects.
 */
